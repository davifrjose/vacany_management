...
import br.com.davifrjose.vacany_management.utils.TestUtils;
...
public class CreateJobControllerTest {
  ...
  public void shouldBeAbleToCreateNewJob() throws Exception{
    ...
    var creteJobDTO = CreateJobDTO.builder()
    ...
    var result = mvc.perform(
      ...
      .content(TestUtils.objectToJson(creteJobDTO))
  ...
  @Test
  public void shouldNotBeAbleToCreateNewJobIfCompanyNofFoud() throws Exception{
    var creteJobDTO = CreateJobDTO.builder()
    .benefits("BENEFITS_TEST")
    .description("DESCRIPTION_TEST")
    .level("LEVEL_TEST")
